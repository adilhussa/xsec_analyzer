...
std::map< int, std::pair< std::string, int > > CC1muXp_MAP = {
  ...
  { kNuMuCCMp0pi_CCQE, { "CCmu0p1pi (CCQE)", kRed } },
  { kNuMuCC0p1pi_CCCOH, { "CCmu0p1pi (CCCOH)", kRed + 1 } },
  { kNuMuCC0p1pi_CCMEC, { "CCmu0p1pi (CCMEC)", kRed + 2 } },
  { kNuMuCC0p1pi_CCRES, { "CCmu0p1pi (CCRES)", kRed + 3 } },
  { kNuMuCC0p1pi_CCDIS, { "CCmu0p1pi (CCDIS)", kRed + 4 } },
  { kNuMuCC0p1pi_Other, { "CCmu0p1pi (Other)", kRed + 5 } },
