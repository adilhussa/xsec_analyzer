...
void set_event_branch_addresses(TTree& etree, AnalysisEvent& ev)
{
  ...
  if ( has_shower_branches ) {
    ...
    set_object_input_branch_address( etree, "trk_trunk_rr_dEdx_u_v" ,ev.track_trunk_rr_dEdx_u_v_ );
  }
  else {
  ...
  set_object_input_branch_address( etree, "trk_energy_muon_v", ev.trk_energy_muon_v_ );
  ...
  bool create = false)
{
  ...
  if ( ev.shower_startx_ ) {
    ...
    set_object_output_branch_address< std::vector<float> >( out_tree, "trk_trunk_rr_dEdx_u_v", ev.track_trunk_rr_dEdx_u_v_, create );
  ...
  set_object_output_branch_address< std::vector<float> >( out_tree, "trk_energy_muon_v", ev.trk_energy_muon_v_, create );
